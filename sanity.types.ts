...
// Query: *[_type == "startup" && defined(slug.current) && ($search == null || title match $search || description match $search || category match $search || author -> name match $search)] | order(_createdAt desc)     {     _id,   title,   slug,  _createdAt,  author -> {    _id, name, image, bio  },   views,  description,  category,  image,}
...
export type STARTUP_BY_AUTHOR_QUERYResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  _createdAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == \"startup\" && defined(slug.current) && ($search == null || title match $search || description match $search || category match $search || author -> name match $search)] | order(_createdAt desc) \n    {\n     _id, \n  title, \n  slug,\n  _createdAt,\n  author -> {\n    _id, name, image, bio\n  }, \n  views,\n  description,\n  category,\n  image,\n}": STARTUP_QUERYResult;
